    ...
    */
    ...
    /* The script is NOT originaly created by ME!!! I dont know WHO is the ORIGINAL AUTHOR!!!!
    *
    *              
    *   If you have ANY BUILD ERRORS, Contact With me.
	*/
    ...
    public:
        ...
        class spell_gb_burning_pitch_SpellScript : public SpellScript
        {
            ...
            {
                if (!sSpellMgr->GetSpellEntry(SPELL_BURNING_PITCH_SIEGE_DMG_A))
                    return false;
                if (!sSpellMgr->GetSpellEntry(SPELL_BURNING_PITCH_SIEGE_DMG_H))
                    return false;
                if (!sSpellMgr->GetSpellEntry(SPELL_BURNING_PITCH_AOE_DAMAGE))
                    return false;
                return true;
            }
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
                ...
                if (GetSpellEntry()->Id == SPELL_BURNING_PITCH_A)
