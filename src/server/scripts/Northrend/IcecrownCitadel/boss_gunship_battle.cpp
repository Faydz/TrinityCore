    /* Umbra Core (c) 2013 - Gunship.cpp
    *
    *  ToDo:
    *  Need to code in Fail Senarios: See Lines 263 - 277 Approx
    *  Needs Triggers spell #69488 Fixed: See Line 46 Approx
    *  Needs Proper SQL - See End Notations
    *
    */
