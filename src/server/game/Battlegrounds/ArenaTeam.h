...
class ArenaTeam
{
    public:
        ...
        static int32 GetRatingMod(uint32 ownRating, uint32 ownMMRating, uint32 opponentRating, bool won);
        ...
        void MemberWon(Player* player, uint32 ownMMRating, uint32 againstMatchmakerRating, int32 matchmakerRatingChange = 12);

        int32 LostAgainst(uint32 ownMMRating, uint32 opponentMMRating, int32& rating_change);
        void MemberLost(Player* player, uint32 ownMMRating, uint32 againstMatchmakerRating, int32 matchmakerRatingChange = -12);
        void OfflineMemberLost(uint64 guid, uint32 ownMMRating, uint32 againstMatchmakerRating, int32 matchmakerRatingChange = -12);
