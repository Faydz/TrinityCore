...
{
    BG_REWARD_WINNER_HONOR_FIRST    = 270 * 2,
    BG_REWARD_WINNER_CONQUEST_FIRST = 1000,
    BG_REWARD_WINNER_HONOR_LAST     = 135 * 2,
    BG_REWARD_WINNER_CONQUEST_LAST  = 500,
    BG_REWARD_LOSER_HONOR_FIRST     = 45 * 2,
    BG_REWARD_LOSER_HONOR_LAST      = 45 * 2
};
