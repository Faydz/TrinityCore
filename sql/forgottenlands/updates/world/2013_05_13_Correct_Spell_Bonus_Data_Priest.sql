...
(15407, 0, 0.864, 0, 0, 'priest- mind flay');
(589, 0, 0.966, 0, 0, 'priest- shadow word pain');
(8092, 1.104, 0, 0, 0, 'priest- mind blast');
(2944, 0, 1.304, 0, 0, 'priest- devouring plague');
(32379, 0.316, 0, 0, 0, 'priest- shadow word death');
(48045, 0, 1.311, 0, 0, 'priest- mind sear');
(73510, 0.836, 0, 0, 0, 'priest- mind spike');
(34914, 0, 1.76, 0, 0, 'priest- vampiric touch');
