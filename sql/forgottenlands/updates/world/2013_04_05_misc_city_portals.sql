...
-- Portal to Deepholm
INSERT INTO `gameobject` VALUES (null, 207689, 0, 1, 1, -8223.48, 451.378, 117.462, 2.79452, 0, 0, 0, 0.98498, 0.172668, 300, 1);

-- Portal to Mount Hyjal
DELETE FROM `gameobject` WHERE (`id`='207688');
INSERT INTO `gameobject` VALUES (null, 207688, 0, 1, 1, -8212.52, 399.422, 117.307, 1.00555, 0, 0, 0, 0.481859, 0.876249, 300, 1);
INSERT INTO `gameobject` VALUES (null, 207688, 1, 1, 1, 2042.18, -4395.65, 98.056, 0, 0, 0, 0, 0.481859, 0.876249, 300, 1);

-- Portal to Uldum
INSERT INTO `gameobject` VALUES (null, 207687, 0, 1, 1, -8233.36, 415.888, 117.505, 0.777982, 0, 0, 0.379255, 0.925292, 300, 0, 1);

-- Portal to Twilight Highlands
DELETE FROM `gameobject` WHERE (`id`='207686');
INSERT INTO `gameobject` VALUES (null, 207686, 0, 1, 1, -8186, 413.653, 116.77, 2.4391, 0, 0, 0.938944, 0.344069, 300, 0, 1);
